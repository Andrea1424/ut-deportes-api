...
$registros=mysqli_query($conexion,"SELECT * FROM usuarios u inner join actividades_usuarios au on au.idUsuario = u.idUsuario inner join actividades a on a.idActividad = au.idActividad inner join carreras c on c.idCarrera = u.idCarrera where au.idActividad = '".$idActividad."' AND u.matricula like '%".$matricula."%'");
