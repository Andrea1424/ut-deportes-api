...
$registros=mysqli_query($conexion,"SELECT * FROM tutorias.usuarios u inner join actividades_usuarios au on au.idUsuario = u.idUsuario inner join actividades a on a.idActividad = au.idActividad where u.matricula like '%".$matricula."%'");
