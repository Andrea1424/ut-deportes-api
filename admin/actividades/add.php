<?php
// Tipo de archivo que recibe
header('Content-Type: text/html');
// Es para controlar la dirección IP o dominio de donde se hace la petición
header('Access-Control-Allow-Origin: *');
// Es para controlar quien tiene acceso
header('Access-Control-Allow-Credentials: true');
// Es para recibir el tipo de dato
