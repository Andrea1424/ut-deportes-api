...
if ($_SERVER['REQUEST_METHOD'] != 'GET') {
  ...
  $registros=mysqli_query($conexion,"SELECT * FROM `actividades` inner join instructores ins on ins.idInstructor = actividades.idInstructor WHERE actividades.idInstructor = '".$idInstructor."'");
