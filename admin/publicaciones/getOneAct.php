...
$registros=mysqli_query($conexion,"SELECT * FROM `publicaciones` p inner join instructores ins on ins.idInstructor = p.idInstructor WHERE `idActividad` = '".$idActividad."'");
