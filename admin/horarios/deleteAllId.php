<?php
  ...
  $res = mysqli_query($conexion, "SELECT * FROM `horarios` WHERE `idActividad`='".$idActividad."'"); // Consulta para saber si ya existe ese valor
  ...
  $delete = mysqli_query($conexion,"DELETE FROM `horarios` WHERE `horarios`.`idActividad`= '".$idActividad."'"); // Se obtiene de la peticion GET en la URL
